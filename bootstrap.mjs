...
function parsePlugin(value, index) {
	...
	if (value.target !== void 0) {
		if (!isRecord$2(value.target)) throw new TypeError(field + ".target must be an object");
...
function parseManifestV2(raw, team, devices) {
	...
	if (!isRecord$2(raw.assignments)) throw new TypeError("assignments must be an object");
	const assignments = {};
	const plugins = [];
